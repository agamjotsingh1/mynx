  ...
  /* Main and Proc_0 in the Ada version             */
{
  ...
  /* (long) cast: HZ*Number_Of_Runs overflows 32-bit int at these clocks */
  ...
  /* DMIPS = Dhrystones/sec / 1757 (VAX-11/780 = 1 MIPS reference) */
  {
    long dmips_milli = (Dhrystones_Per_Second * 1000) / 1757;
    printf("DMIPS:                                      %ld.%ld\n",
           dmips_milli / 1000, dmips_milli % 1000);
#ifdef CORE_MHZ
    long dmm_milli = dmips_milli / CORE_MHZ;
    printf("DMIPS/MHz:                                  %ld.%ld\n",
           dmm_milli / 1000, dmm_milli % 1000);
#endif
  }

...
\
  ...
  if { [catch {set disp_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  # Create instance: text_bram, and set properties
  set text_bram [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 text_bram ]
  set_property -dict [list \
    CONFIG.Byte_Size {8} \
    ...
    CONFIG.Write_Depth_A {7200} \
    CONFIG.Write_Width_A {8} \
    CONFIG.use_bram_block {Stand_Alone} \
  ] $text_bram


  # Create instance: kb_valid, and set properties
  set kb_valid [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 kb_valid ]
  set_property -dict [list \
  ...
  # Create instance: kb, and set properties
  set kb [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 kb ]
  set_property -dict [list \
    CONFIG.C_ALL_OUTPUTS {1} \
  ...
  set core_rst [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 core_rst ]
  set_property -dict [list \
    CONFIG.C_ALL_OUTPUTS {1} \
  ...
  # Create instance: amc_a, and set properties
  set block_name amc
  set block_cell_name amc_a
  if { [catch {set amc_a [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $amc_a eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: amc_b, and set properties
  set block_name amc
  set block_cell_name amc_b
  if { [catch {set amc_b [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $amc_b eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: phy_ps_addr, and set properties
  set phy_ps_addr [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 phy_ps_addr ]
  ...
  connect_bd_intf_net -intf_net axi_smc_M03_AXI [get_bd_intf_pins axi_smc/M03_AXI] [get_bd_intf_pins phy_ps_addr/S_AXI]
  ...
  connect_bd_net [get_bd_pins amc_a/busy] \
  [get_bd_pins core_0/__amc_busy_a]
  connect_bd_net [get_bd_pins amc_a/data_in_index] \
  [get_bd_pins core_0/__amc_data_in_index_a]
  connect_bd_net [get_bd_pins amc_a/data_in_last] \
  [get_bd_pins core_0/__amc_data_in_last_a]
  connect_bd_net [get_bd_pins amc_a/data_in_valid] \
  [get_bd_pins core_0/__amc_data_in_valid_a]
  connect_bd_net [get_bd_pins amc_a/data_out] \
  [get_bd_pins core_0/__amc_data_out_a]
  connect_bd_net [get_bd_pins amc_a/data_out_index] \
  [get_bd_pins core_0/__amc_data_out_index_a]
  connect_bd_net [get_bd_pins amc_a/data_out_last] \
  [get_bd_pins core_0/__amc_data_out_last_a]
  connect_bd_net [get_bd_pins amc_a/data_out_valid] \
  [get_bd_pins core_0/__amc_data_out_valid_a]
  connect_bd_net [get_bd_pins amc_a/err] \
  [get_bd_pins core_0/__amc_err_a]
  connect_bd_net [get_bd_pins amc_b/busy] \
  [get_bd_pins core_0/__amc_busy_b]
  connect_bd_net [get_bd_pins amc_b/data_in_index] \
  [get_bd_pins core_0/__amc_data_in_index_b]
  connect_bd_net [get_bd_pins amc_b/data_in_last] \
  [get_bd_pins core_0/__amc_data_in_last_b]
  connect_bd_net [get_bd_pins amc_b/data_in_valid] \
  [get_bd_pins core_0/__amc_data_in_valid_b]
  connect_bd_net [get_bd_pins amc_b/data_out] \
  [get_bd_pins core_0/__amc_data_out_b]
  connect_bd_net [get_bd_pins amc_b/data_out_index] \
  [get_bd_pins core_0/__amc_data_out_index_b]
  connect_bd_net [get_bd_pins amc_b/data_out_last] \
  [get_bd_pins core_0/__amc_data_out_last_b]
  connect_bd_net [get_bd_pins amc_b/data_out_valid] \
  ...
  [get_bd_pins disp_0/pixel_clk]
  connect_bd_net [get_bd_pins clk_wiz_0/clk_out2] \
  [get_bd_pins proc_sys_reset_2/slowest_sync_clk] \
  [get_bd_pins rgb2dvi/SerialClk]
  connect_bd_net [get_bd_pins core_0/__amc_addr_a] \
  [get_bd_pins amc_a/addr]
  connect_bd_net [get_bd_pins core_0/__amc_addr_b] \
  [get_bd_pins amc_b/addr]
  connect_bd_net [get_bd_pins core_0/__amc_data_in_a] \
  [get_bd_pins amc_a/data_in]
  connect_bd_net [get_bd_pins core_0/__amc_data_in_b] \
  [get_bd_pins amc_b/data_in]
  connect_bd_net [get_bd_pins core_0/__amc_mem_read_a] \
  [get_bd_pins amc_a/mem_read]
  connect_bd_net [get_bd_pins core_0/__amc_mem_read_b] \
  [get_bd_pins amc_b/mem_read]
  connect_bd_net [get_bd_pins core_0/__amc_mem_write_a] \
  ...
  [get_bd_pins text_bram/addrb]
  connect_bd_net [get_bd_pins disp_0/__textram_clka] \
  [get_bd_pins text_bram/clka]
  connect_bd_net [get_bd_pins disp_0/__textram_clkb] \
  [get_bd_pins text_bram/clkb]
  connect_bd_net [get_bd_pins disp_0/__textram_dina] \
  [get_bd_pins text_bram/dina]
  connect_bd_net [get_bd_pins disp_0/__textram_ena] \
  [get_bd_pins text_bram/ena]
  connect_bd_net [get_bd_pins disp_0/__textram_enb] \
  [get_bd_pins text_bram/enb]
  connect_bd_net [get_bd_pins disp_0/__textram_wea] \
  [get_bd_pins text_bram/wea]
  connect_bd_net [get_bd_pins disp_0/__textram_web] \
  [get_bd_pins text_bram/web]
  connect_bd_net [get_bd_pins disp_0/active_video] \
  [get_bd_pins rgb2dvi/vid_pVDE]
  connect_bd_net [get_bd_pins disp_0/hsync] \
  [get_bd_pins rgb2dvi/vid_pHSync]
  connect_bd_net [get_bd_pins disp_0/ready] \
  [get_bd_pins core_0/tx_ready]
  connect_bd_net [get_bd_pins disp_0/rgb] \
  [get_bd_pins rgb2dvi/vid_pData]
  connect_bd_net [get_bd_pins disp_0/vsync] \
  [get_bd_pins rgb2dvi/vid_pVSync]
  connect_bd_net [get_bd_pins kb/gpio_io_o] \
  [get_bd_pins core_0/rx_data]
  connect_bd_net [get_bd_pins kb_valid/gpio_io_o] \
  [get_bd_pins core_0/rx_valid]
  ...
  [get_bd_pins rgb2dvi/aRst_n]
  connect_bd_net [get_bd_pins proc_sys_reset_3/peripheral_aresetn] \
  ...
  assign_bd_address -offset 0x41220000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs core_rst/S_AXI/Reg] -force
  assign_bd_address -offset 0x41200000 -range 0x00010000 -with_name SEG_keyboard_Reg -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs kb/S_AXI/Reg] -force
  assign_bd_address -offset 0x41230000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs phy_ps_addr/S_AXI/Reg] -force

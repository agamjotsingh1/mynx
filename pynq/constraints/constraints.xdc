...
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { spi_sd_ss_io[0] }]; # AR10 (CS)
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { spi_sd_io0_io }];   # AR11 (MOSI)
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { spi_sd_io1_io }];   # AR12 (MISO)
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { spi_sd_sck_io }];   # AR13 (SCK)

...
uint64_t correct_alu(uint8_t op, uint64_t in1, uint64_t in2) {
    switch (op) {
        case ALU_OP_ADD:  return in1 + in2;
        case ALU_OP_SUB:  return in1 - in2;
        case ALU_OP_XOR:  return in1 ^ in2;
        case ALU_OP_OR:   return in1 | in2;
        case ALU_OP_AND:  return in1 & in2;
        case ALU_OP_SLL:  return in1 << in2;
        case ALU_OP_SRL:  return in1 >> in2;
        case ALU_OP_SRA:  return (uint64_t)(((int64_t)in1) >> in2);
        case ALU_OP_SLT:  return ((int64_t)in1 < (int64_t)in2) ? 1 : 0;
        case ALU_OP_SLTU: return (in1 < in2) ? 1 : 0;
        default:          return 0;
    }
}
